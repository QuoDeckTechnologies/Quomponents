...
export default function DeckSettingsSection(props) {
  ...
  if (
    ...
    deckSettingsSection.enableNavigation =
      tObj?.enableNavigation || "Enable Navigation";
    deckSettingsSection.enableSlideList =
      tObj?.enableSlideList || "Enable Slide List";
    deckSettingsSection.enableVoiceovers =
      tObj?.enableVoiceovers || "Enable Voiceovers";
  }
  ...
  const [isVoiceoverEnabled, setVoiceoverChecked] = useState(
    props.deck?.voEnabled
  );
          ...
          <div className="qui-ribbon-menu-settings-section-child-container">
            <div className="qui-ribbon-menu-settings-section-child">
              <div className="qui-ribbon-menu-settings-section-right-content">
                <IconLink
                  ...
                  withIcon={{
                    icon: `qui-ribbon-file-right-icons ${
                      isNavEnabled ? "far fa-check-square" : "far fa-square"
                    }`,
                  }}
                  onClick={() => {
                ...
                />
                <div
                  className="qt-tn qui-ribbon-menu-label"
                  onClick={() => {
                    toggleNavigationChecked();
                    handleChangeDeckSettings({
                      navEnabled: !isNavEnabled,
              ...
              <div className="qui-ribbon-menu-settings-section-right-content">
                <IconLink
                  ...
                  withIcon={{
                    icon: `qui-ribbon-file-right-icons ${
                      isSlideEnabled ? "far fa-check-square" : "far fa-square"
                    }`,
                  }}
                  onClick={() => {
                    toggleSlideChecked();
