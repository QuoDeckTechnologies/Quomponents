...
FourCardCarousel.propTypes = {
    //======================================
    //component specific props
    //======================================
    /**
    FourCardCarousel data should be passed in content field and it is required field
    */
    ...
    /**
    FourCardCarousel data should be passed imageLibrary
    */
...
**/
export default function FourCardCarousel(props) {
    const sliderRef = useRef();
    let { content } = props;
    let quommonClasses = getQuommons(props, "four-card-carousel");
    //-------------------------------------------------------------------
                    ...
                    return (
                        <div className="qui-mobile-slide-container "
                            ...
                            <div className={`qui-mobile-slide `}>
                                <VCardWithButton  {...props} content={slide} onClick={props.onClick} buttonText={content?.buttonText} checked={true} />
                            </div>
                        </div>
                    );
                })}
