  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="qui-deckblock-bottom"
          style={
            props?.status === true
        ...
        >
          <h6> {props?.status ? checkSlide + props?.slideCount : "..."}</h6>
        </div>
      </div>
    </motion.div>
  );
