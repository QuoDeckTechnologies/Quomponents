      ...
      return (
        <div className="qui-status">
          <div className={`qui-statusInner`}>
            <p style={headerColors}>
              {tObj?.text[status.replace(" ", "")] || status.toUpperCase()}
            </p>
            <i className={`${iconClass}`} style={accentColors}></i>
          </div>
        </div>
      );
    }
    ...
    >
      <div className={`qui-certificate-card  ${quommonClasses.childClasses}`}>
        <div className="qui-header">
          <div className={`qui-colorBanner`} style={bannerColors}></div>
          <div className={`qui-courseHeader`} style={headerColors}>
