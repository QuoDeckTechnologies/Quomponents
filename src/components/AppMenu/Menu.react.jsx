...
export default function Menu(props) {
    ...
    return (
        <div
           ...
           >
            <div className={`qui-MenuIcon  ${quommonClasses.childClasses}`} style={Object.assign({}, colors, props.style)} onClick={props.onClick}>
                <div className="qui-iconDiv"></div>
                <i className={`${props.withIcon ? props.withIcon.icon :""} qui-MenuIcon`}></i>
            </div>
        </div>       
