...
ClozeWithFeedback.propTypes = {
    ...
    */
    ...
    /**
    ClozeWithFeedback component must have the onClick function passed as props
    */
        ...
        >
            {data &&
                <div className="qui-cloze-with-feedback-card" style={{ ...background }}>
                    ...
                    {data?.image && (
                        <img className="qui-cloze-with-feedback-image" src={resolveImage(data?.image.id, imageLibrary)} alt="" />
                    )}
                    <div
