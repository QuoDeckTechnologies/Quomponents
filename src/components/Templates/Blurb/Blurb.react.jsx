...
Blurb.propTypes = {
  ...
  /**
    Blurb can set presenter and background image from imageLibrary array
    */
...
export default function Blurb(props) {
  ...
  //-------------------------------------------------------------------
  // 3. Function to return a view for Blurb
  //-------------------------------------------------------------------
  const getView = (data) => {
  ...
  //-------------------------------------------------------------------
  // 5. Function to return a view for Blurb with presenter
  //-------------------------------------------------------------------
  ...
  return (
    ...
    >
      {!data?.presenter && (
        <div
          className={`qui-Blurb-container ${quommonClasses.childClasses}`}
        >
          <div className={`qui-Blurb-slide-header`}>{getView(data)}</div>
        </div>
      )}
