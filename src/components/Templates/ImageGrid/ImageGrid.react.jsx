...
export default function ImageGrid(props) {
  ...
  const ImageGridView = (data) => {
    return (
      <div
        className="qui-image-grid-card"
        key={"imageGrid-slide-" + props.slideId}
        style={{
          ...background,
      ...
      >
        ...
        >
          ...
          {data?.image && (
            <img
              className="qui-image-grid-image"
        ...
        <Grid
          ...
          className="qui-image-grid-container"
        >
  ...
  const ImageGridPresenterView = (data) => {
    return (
      <div
        className="qui-image-grid-presenter-container"
        style={{
          ...background,
          backgroundColor: withColor?.backgroundColor,
          backgroundRepeat: "no-repeat",
