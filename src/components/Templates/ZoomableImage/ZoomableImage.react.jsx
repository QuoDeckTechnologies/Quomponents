...
export default function ZoomableImage(props) {
  ...
  const zoomabelImage = (data) => {
    if (fullScreen) {
            ...
            >
              <div className="qui-zoomable-image-conteiner">
                ...
                <div className="qui-pinchview-zoom">
                  {pinch && (
                    <img
                      className="qui-pinchview-zoomable-hint"
                      src={PinchImage}
                      alt=""
                    />
                  )}
                  {data?.zoomableImage && (
                    <img
                      className="qui-pinchview-zoomable-image"
                      src={resolveImage(data.zoomableImage.id, imageLibrary)}
                      alt=""
                    />
                  )}
                </div>
      ...
      return (
        <div
          className="qui-zoomable-image-card"
          key={"zoomable-image-slide-" + slideId}
          style={{
            ...background,
        ...
        >
          ...
          >
            ...
            {data?.image && (
              <img
                className="qui-header-image qt-shadow"
            ...
            <div className="qui-pinchview-zoom">
              {pinch && (
                <img className="qui-pinchview-image" src={PinchImage} alt="" />
              )}

              {data?.zoomableImage && (
                <img
                  className="qui-zoomable-picture qt-shadow"
                  src={resolveImage(data.zoomableImage.id, imageLibrary)}
                  alt=""
                />
              )}
  ...
  const zoomableImagePresenterView = (data) => {
    if (fullScreen) {
      ...
      return (
        <div
          className="qui-zoomable-image-presenter-container"
          style={{
            ...background,
            backgroundColor: withColor?.backgroundColor,
            backgroundRepeat: "no-repeat",
  ...
  return (
    ...
    >
      {data && (
        <div>
          {data?.presenter
            ? zoomableImagePresenterView(data)
            : zoomabelImage(data)}
        </div>
      )}
    </motion.div>
