...
Video.propTypes = {
    ...
    //=======================================
    /**
    Video data should be passed in data field and it is a required field
    */
...
export default function Video(props) {
    ...
    // 2. Set the classes
    //-------------------------------------------------------------------
    let quommonClasses = getQuommons(props, "video");
    //-------------------------------------------------------------------
    // 3. Use to set Color in Video
    //-------------------------------------------------------------------
