...
export default function ConfirmationOverlay(props) {
  ...
  let mainColors = props.withColor ? getColors(props.withColor, "main") : {},
    confirmColors = props.withColor
      ? getColors(props.withColor, "confirm")
      : {},
  ...
  return (
    ...
    >
      <div
        className={`qui-confirmation-overlay-group ${quommonClasses.childClasses}`}
      >
        <h5 className="qui-overlay-header">{header || "Are you sure?"}</h5>
