...
export default function ProgressBar(props) {
  ...
  let rightArrowStyle = {
    color:
      currentIndex === totalSlides && enableRightNavigation
        ? "#aaaaaa"
  ...
  let leftArrowStyle = {
    color:
      currentIndex === 1 && enableLeftNavigation
        ? "#aaaaaa"
        : withColor?.accentColor,
  };
  // ========================= Render Function =================================
  return (
    ...
    >
      <div className={`qui-progressbar${quommonClasses.childClasses}`}>
        <div>
          <i
            className={`qui-progressbaricons ${
              leftIcon ? leftIcon : "fa fa-arrow-alt-circle-left"
            }`}
              ...
              <div
                ...
                style={
                  currentIndex >= index + 1
                    ? { backgroundColor: withColor?.hoverTextColor }
                    : { backgroundColor: withColor?.textColor }
                }
              ></div>
            );
          })}
        ...
        <div>
          <i
            className={`qui-progressbaricons ${
              rightIcon ? rightIcon : "fa fa-arrow-alt-circle-right"
            }`}
