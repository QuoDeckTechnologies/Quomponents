...
export default function CourseCard(props) {
    ...
    if (
        ...
        isSequential = props.content?.sequential
            ? tObj?.isSequential?.true || "Sequential Course"
            : tObj?.isSequential?.false || "Non Sequential Course";
    ...
    const getDate = () => {
        ...
        return `${startDate} ${getMonth(startMonth)} - ${endDate} ${getMonth(
            endMonth
        )}`;
    };
                ...
                <div className="qui-course-card-body">
                    <div className={`qui-course-card-title-container`}>
                        <div className={`qui-nugget-block-styling`}>
                            <NuggetBlock
                                status={status}
                                image={"../../assets/nuggets/nugget_course.png"}
                            />
                        </div>
                    ...
                    <div className="qui-course-card-date-and-tags-container">
                        <div className="qui-course-card-show-more-date-container">
                            {showMoreBtn && (
                                <div
                                    className={`qui-course-card-show-more-container`}
                                >
                                    <button
                            ...
                            {props.content?.date?.start_date &&
                                props.content?.date?.end_date && (
