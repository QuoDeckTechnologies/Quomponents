    ...
    return (
        <div
            ...
            <div className={`${quommonClasses.childClasses} qui-today-menu-btn-container`} style={{ backgroundColor: colors?.backgroundColor }}
                ...
                {props.withIcon?.icon && <i className={`${props.withIcon?.icon} qui-icon qui-today-menu-btn-icon`} style={{ color: colors?.accentColor }} />}
                <span><h6 className={`qui-today-menu-btn-text`} style={{ color: colors?.textColor, marginLeft: props.withIcon?.icon ? " 0.5em" : "0" }} >
                    {props.content}
                </h6></span>
            </div>
        </div>
