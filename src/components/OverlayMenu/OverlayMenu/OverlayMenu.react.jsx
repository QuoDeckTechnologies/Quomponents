...
OverlayMenu.propTypes = {
    ...
    /**
    OverlayMenu Text has to be in content or passed as children to the component. Is optional if you only want an icon.
    */
...
- MUI props are not being passed to the OverlayMenu. Please speak to the admin to handle any new MUI prop.
**/
export default function OverlayMenu(props) {
    ...
    // 1. Set the classes
    //-------------------------------------------------------------------
    let quommonClasses = getQuommons(props, "OverlayMenu");
    if (props.isCircular)
    ...
    //-------------------------------------------------------------------
    // 3. Set the OverlayMenu text
    //-------------------------------------------------------------------
    let OverlayMenuText = props.content
        ? props.content
        : props.children
            ? props.children
            : "";
    let iconOnly = OverlayMenuText === "";
    ...
    //-------------------------------------------------------------------
    OverlayMenuText = props.isLoading ? loadingText : OverlayMenuText;
