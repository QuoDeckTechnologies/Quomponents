...
export default function SerialCard(props) {
  ...
  return (
    ...
    >
      <div
        className={`qui-serialcard-container ${quommonClasses.childClasses}`}
      >
        <div className="qui-serialcard-top">
          <img
            className="qui-serialcard-backimg"
            src={props.backImage}
            alt=""
          />
        ...
        <div className="qui-serialcard-bottom">
          ...
          <div className={"qui-serialcard-player"}>
            <i
              className={`qui-serialcard-player-icon ${props.playerIcon}`}
              style={colors.accentColors}
            />
            <span className="qt-sm" style={colors.textColors}>
              {props.playersValue}
            </span>
          </div>
