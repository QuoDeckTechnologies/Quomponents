        ...
        <div
          ...
          style={
            isActive
              ...
              : Object.assign({}, colors.buttonHandle)
          }
        >
          <div
            className={`qui-btn qui-label emp-text`}
            style={Object.assign({}, colors.lableHandle)}
          >
            <div className="qui qt-utn">{getLabel(labelContent, "label")}</div>
          </div>
          {props.withIcon?.icon && (
            <i
              className={`qui-icon ${props.withIcon?.icon} qui-iconlink-icon ${
                tilt ? "tilt" : ""
              }`}
            ></i>
          )}
          <div
            className={`qui-btn qui-caption emp-text`}
            style={Object.assign({}, colors.lableHandle)}
          >
            <div className="qui qt-utn">
