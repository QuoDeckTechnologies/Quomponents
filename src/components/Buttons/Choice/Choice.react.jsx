    ...
    >
      {props.options && (
        <div className="qui-choice-container">
          <div className="qui-choice-container-content-one">
            ...
            {withLabel?.format === "popover" && (
              <div className={`qui-lable-popover-one size-${props.asSize}`}>
          ...
          <div
            className={`qui-or ${
              props.withLabel?.format === "label"
                ? "-label"
                : props.withLabel?.format === "caption"
                ? "-caption"
                : ""
            } pad-${props.asPadded} size-${props.asSize}`}
            style={Object.assign({}, orStyle)}
          >
            OR
          </div>
          <div className="qui-choice-container-content-two">
            <div className="qui-label qt-lbl" style={labelStyle}>
            ...
            {withLabel?.format === "popover" && (
              <div className={`qui-lable-popover-two size-${props.asSize}`}>
