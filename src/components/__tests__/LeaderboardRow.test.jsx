...
describe("LeaderboardRow", () => {
  ...
  it("should render the component without points and align the name text to the right", () => {
    ...
    expect(
      component.find(".qui-leaderboard-row-name").props().style.textAlign
    ).toBe("right");
    expect(component.find(".qui-leaderboard-row-name").text()).toBe(
      "Rohit Dhende"
    );
  ...
  it("should render the component with correct styles when passed ranks between 0 to 2", () => {
    ...
    expect(
      component.find(".qui-leaderboard-row-container").props().style
        .backgroundColor
    ).toBe("#454545");
    expect(
      component.find(".qui-leaderboard-row-name").props().style.color
    ).toBe("#000");
    expect(component.find(".qui-leaderboard-row-name").text()).toBe(
      "Rohit Dhende"
    );
