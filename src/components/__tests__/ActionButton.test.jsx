...
describe("ActionButton", () => {
  const args = {
    ...
    required: {
      content: {
        ...
        subTitle: "Rs. 75",
        image:
          "https://media.glassdoor.com/sqll/1666177/quodeck-squarelogo-1519202233122.png",
      },
      onClick: () => {},
    },
    translations: {
  ...
  it("should render button when image not passed", () => {
    ...
    expect(button.props().className).toBe(
      "qui-btn variant-secondary action-button"
    );
  });
  ...
  it("should render component without ellipse when isEllipse is passed as false", () => {
    ...
    expect(container.props().className).toBe(
      "action-button-container-with-no-ellipse"
    );
  });
