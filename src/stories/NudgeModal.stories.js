...
import NudgeModal from "../components/NudgeModal/NudgeModal.react";
...
export default {
  title: "Design System/NudgeModal",
  component: NudgeModal,
  argTypes: {
    isOpen: {
      defaultValue: true,
    },
...
Default.parameters = {
  docs: {
    source: {
      code: `<NudgeModal {...${JSON.stringify(
        Default.args,
        null,
        2
      )}}/>`,
...
// -------------------------------------------------------------
export const ColoredNudgeModal = Template.bind({});
ColoredNudgeModal.args = {
  ...Default.args,
  asVariant: "secondary",
  withColor: {
...
// -------------------------------------------------------------
export const TranslatedNudgeModal = Template.bind({});
TranslatedNudgeModal.args = {
  ...Default.args,
  withTranslation: {
    lang: "hi",
    tgt: "voiceoveruploadmodal",
...
TranslatedNudgeModal.parameters = {
  docs: {
    description: {
