...
const dictionary = JSON.stringify({
  hi: {
    faqItem: {
      ...
      answer:
        "बिक्री शब्दावली की दुनिया में खो जाना आसान हो सकता है। किसी भी क्षेत्र की तरह, जब आपका पहली बार लिंगो से परिचय होता है, तो यह एक नई भाषा सीखने जैसा महसूस हो सकता है। समान शब्दों के बीच महत्वपूर्ण अंतर को समझना अपने आप में एक चुनौती हो सकती है।",
    },
  },
});
...
Default.args = {
  question:
    "Q. What is the difference between Sales Readiness and Sales Enablement",
  answer:
...
ColoredFAQItem.parameters = {
  docs: {
    description: {
      story: "Use to override the standard colors of the FAQItem.",
    },
    source: {
      code: `<FAQItem 
            question= "Question"
...
TranslatedFAQItem.parameters = {
  docs: {
    description: {
      story: "Use to change the language that the text appears in FAQItem.",
    },
    source: {
      code: `<FAQItem 
            question= "Question"
