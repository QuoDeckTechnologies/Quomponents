...
export default {
    ...
    parameters: {
        componentSubtitle:
            "Displays OptionItem component with an ImageField and InputField for input and caption.",
        a11y: { disable: true },
        docs: {
            iframeHeight: 250,
        },
...
Default.args = {
    header: {
        ...
        placeholder: "Put in a header",
        maxLength: 80,
        width: "80%",
    },
    caption: {
        value: "This is the caption",
        placeholder: "Put in a caption",
        maxLength: 0,
        width: "100%",
    },
    image: {
                ...
                return (
                    <div style={{ marginBottom: "1em" }} key={index}>
                        <OptionItemSix
                            {...args}
                            content={{ ...content }}
                            onUpload={(targetName, image) =>
                                handleUpload(targetName, image)
                            }
