...
export const SlideSettingsWithThreeSlides = (args) => {
  ...
  return (
    <div>
      <SlideSettings {...Object.assign({}, baseObj1, {})} />
    </div>
  );
};
SlideSettingsWithThreeSlides.parameters = {
  docs: {
    description: {
      story:
        "If there are 3 slides and user is at second slide then the next and back arrows will be able to enable",
    },
    source: {
      code: `<SlideSettings {...${JSON.stringify(Default.args, null, 2)}}/>`,
    },
...
SlideSettingsWithOneSlide.parameters = {
  docs: {
    description: {
      story:
        "If there is only 1 slide then user will not be able to enable next and back arrows",
    },
    source: {
      code: `<SlideSettings {...${JSON.stringify(Default.args, null, 2)}}/>`,
    },
...
WhenAtSecondSlide.parameters = {
  docs: {
    description: {
      story:
        "If there are only 2 slides and user is at second slide, next arrow will get disabled",
    },
    source: {
      code: `<SlideSettings {...${JSON.stringify(Default.args, null, 2)}}/>`,
    },
...
WhenAtFirstSlide.parameters = {
  docs: {
    description: {
      story:
        "If there are only 2 slides and user is at second slide, back arrow will get disabled",
    },
    source: {
      code: `<SlideSettings {...${JSON.stringify(Default.args, null, 2)}}/>`,
    },
