...
const dictionary = JSON.stringify({
  hi: {
    voiceoveruploadmodal: {
      ...
      text: "प्रत्येक स्लाइड के लिए अलग-अलग एमपी3 फाइलें बनाएं और उन्हें उन स्लाइड नंबरों के रूप में नाम दें जिनसे वे मेल खाते हैं। जैसे 1.mp3, 2.mp3, आदि। आप कर सकते हैं इस तरह से एक या अधिक स्लाइड के लिए वॉयसओवर अपलोड करें...",
      buttons: {
