...
export default {
  ...
  parameters: {
    componentSubtitle:
      "Displays a RedeemCard with offer details and display status as 'Pending','InProgress','Completed'",
    a11y: { disable: true },
...
Default.args = {
  ...
  image:
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeATjmpNd-h_Ks3g4SsBtHhLZ5F3FURym4w7KBqmteMxBmPRLX6oFwH2g1CRT_ckAzzFw&usqp=CAU",
  cost: 500,
  stock: {
    left: 500,
    total: 1000,
...
export const AllVariantsTemplate = (args) => {
  ...
  return (
    <div>
      <RedeemCard {...Object.assign({}, baseObj1, {})} />
      <RedeemCard {...Object.assign({}, baseObj2, {})} />
      <RedeemCard {...Object.assign({}, baseObj3, {})} />
    </div>
  );
};
// -------------------------------------------------------------
