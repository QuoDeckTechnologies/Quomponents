...
// -------------------------------------------------------------
// BulletList with image backgroundImage
// -------------------------------------------------------------
export const withBackgroundImageBulletList = Template.bind({});
withBackgroundImageBulletList.args = {
    ...Default.args,
    data: {
        title: "Neque porro quisquam est qui dolorem",
        subTitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, curabitur ipsum sem",
...
withBackgroundImageBulletList.parameters = {
    docs: {
        description: {
            story:
                "Use to show backgroundImage in the BulletList.",
        },
        source: {
            code: `<withBackgroundImageBulletList {...${JSON.stringify(
                withBackgroundImageBulletList.args,
                null,
                2
            )}}/>`,
