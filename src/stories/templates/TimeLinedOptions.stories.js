...
export default {
  ...
  parameters: {
    componentSubtitle:
      "Displays a TimeLinedOptions component with options, the user need to submit the answer by arranging them using up down buttons, we can switch between the image and SlideHeader by adding or removing the image prop",
    a11y: { disable: true },
    docs: {
      iframeHeight: 650,
    },
...
TimeLinedOptionsWithSlideHeader.parameters = {
  docs: {
    source: {
      code: `<TimeLinedOptions {...${JSON.stringify(
        TimeLinedOptionsWithSlideHeader.args,
        null,
        2
      )}}/>`,
