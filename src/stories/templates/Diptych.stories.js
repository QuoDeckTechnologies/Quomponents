...
export default {
  ...
  parameters: {
    componentSubtitle:
      "Displays a Diptych Slide having 2 clickable images and TextBoxes, we can switch the slideHeader into header image by giving image prop and we can switch the slide into presenter view by adding presenter image to presenter prop ",
    a11y: { disable: true },
    docs: {
      iframeHeight: 700,
    },
...
Default.parameters = {
  docs: {
    description: {
      story:
        "Diptych component have clickable images in between SliderHeader and TextBlock.",
    },
    source: {
...
DefaultWithImage.parameters = {
  docs: {
    ...
    source: {
      code: `<Diptych {...${JSON.stringify(DefaultWithImage.args, null, 2)}}/>`,
    },
  },
};
// -------------------------------------------------------------
