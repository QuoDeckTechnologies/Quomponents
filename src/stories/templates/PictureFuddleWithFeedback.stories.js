...
export default {
  ...
  parameters: {
    componentSubtitle:
      "Displays a PictureFuddleWithFeedback with a question and Input Field, the user need to submit the answer, we can switch between the image and SlideHeader by adding or removing the image prop",
    a11y: { disable: true },
    docs: {
      iframeHeight: 650,
    },
...
// -------------------------------------------------------------
export const PictureFuddleWithFeedbackWithSlideHeaderAndBackgroundImage =
  Template.bind({});
