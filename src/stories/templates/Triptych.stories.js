...
export default {
    ...
    parameters: {
        componentSubtitle: "Displays a Triptych Slide having 3 clickable images and TextBoxes, we can switch the slideHeader into header image by giving image prop and we can switch the slide into presenter view by adding presenter image to presenter prop ",
        a11y: { disable: true },
        docs: {
            iframeHeight: 700,
        },
...
Default.args = {
    ...
    {
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaSuNGHubMynXOcaiAqyl9U8IFkihW-a7N-A&usqp=CAU",
    id: "image-2",
    },
    {
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5nNxhvY6um5GPp5zbeB8SLoTuuvRYK2jn0Q&usqp=CAU",
    id: "image-3",
    },
    ],
    slideId: 0,
...
TriptychWithPresenter.parameters = {
    docs: {
        ...
        source: {
            code: `<Triptych {...${JSON.stringify(TriptychWithPresenter.args, null, 2)}}/>`,
        },
    },
};