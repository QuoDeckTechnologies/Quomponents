...
export default {
  ...
  parameters: {
    componentSubtitle:
      "Displays a Triptych Slide having 3 clickable images and TextBoxes, we can switch the slideHeader into header image by giving image prop and we can switch the slide into presenter view by adding presenter image to presenter prop ",
    a11y: { disable: true },
    docs: {
      iframeHeight: 700,
    },
...
// Default
// -------------------------------------------------------------
const Template = (args) => <Triptych {...args} />;
...
Default.args = {
  ...
  imageLibrary: [
    ...
    {
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaSuNGHubMynXOcaiAqyl9U8IFkihW-a7N-A&usqp=CAU",
      id: "image-2",
    },
    {
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5nNxhvY6um5GPp5zbeB8SLoTuuvRYK2jn0Q&usqp=CAU",
      id: "image-3",
    },
  ],
  slideId: 0,
...
Default.parameters = {
  docs: {
    description: {
      story:
        "Triptych component have clickable images in between SliderHeader and TextBlock.",
    },
    source: {
      code: `<Triptych {...${JSON.stringify(Default.args, null, 2)}}/>`,
    },
  },
};
// -------------------------------------------------------------
...
// -------------------------------------------------------------
// TriptychWithPresenter
// -------------------------------------------------------------
export const TriptychWithPresenter = Template.bind({});
TriptychWithPresenter.args = {
  data: {
    title: "Neque porro quisquam est qui dolorem",
    subtitle:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, curabitur ipsum sem",
...
TriptychWithPresenter.parameters = {
  docs: {
    description: {
      story:
        "Triptych component have clickable images in between SliderHeader and TextBlock.",
