...
export default {
  ...
  parameters: {
    componentSubtitle:
      "Displays a IconListCaptions slide  with SlideHeader, clickableimages and textBlock as caption, Caption will change according to click on image",
    a11y: { disable: true },
    docs: {
      iframeHeight: 400,
    },
...
IconListCaptionsWithImage.parameters = {
  docs: {
    source: {
      code: `<IconListCaptions {...${JSON.stringify(
        IconListCaptionsWithImage.args,
        null,
        2
      )}}/>`,
