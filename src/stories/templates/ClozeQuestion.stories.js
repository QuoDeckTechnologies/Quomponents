...
export default {
	...
	parameters: {
		componentSubtitle:
			"Displays a ClozeQuestion with a question, the user need to submit the correct option as answer, we can switch between the image and SlideHeader by adding or removing the image prop",
		a11y: { disable: true },
		docs: {
			iframeHeight: 650,
		},
...
// -------------------------------------------------------------
// EmphasisClozeQuestion
// -------------------------------------------------------------
export const EmphasisClozeQuestion = Template.bind({});
EmphasisClozeQuestion.args = {
	data: {
		title: "Neque porro quisquam est qui dolorem",
		subtitle:
			"Lorem ipsum dolor sit amet, consectetur adipiscing elit, curabitur ipsum sem",
...
EmphasisClozeQuestion.parameters = {
	docs: {
		source: {
			code: `<ClozeQuestion {...${JSON.stringify(
				EmphasisClozeQuestion.args,
...
// -------------------------------------------------------------
// ColoredClozeQuestion
// -------------------------------------------------------------
export const ColoredClozeQuestion = Template.bind({});
ColoredClozeQuestion.args = {
	data: {
		title: "Neque porro quisquam est qui dolorem",
		subtitle:
			"Lorem ipsum dolor sit amet, consectetur adipiscing elit, curabitur ipsum sem",
...
ColoredClozeQuestion.parameters = {
	docs: {
		source: {
			code: `<ClozeQuestion {...${JSON.stringify(
				ColoredClozeQuestion.args,
