...
export default {
    ...
    parameters: {
        componentSubtitle: "Displays a ImageGrid Slide having 4 clickable images as Grid  , TextBoxes, we can switch the slideHeader into header image by giving image prop and we can switch the slide into presenter view by giving presenter prop ",
        a11y: { disable: true },
        docs: {
            iframeHeight: 700,
        },
...
Default.parameters = {
    docs: {
        description: {
            story: "ImageGrid component have clickable images in between SliderHeader and TextBlock.",
        },
        source: {
            code: `<ImageGrid {...${JSON.stringify(Default.args, null, 2)}}/>`,
        },
    },
};
// -------------------------------------------------------------
// ImageGridWithSlidheader
// -------------------------------------------------------------
export const ImageGridWithSlidheader = Template.bind({});
ImageGridWithSlidheader.args = {
    data: {
        title: "Neque porro quisquam est qui dolorem",
        subtitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, curabitur ipsum sem",
        caption: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In suscipit euismod nisl vitae interdum. Mauris ac vestibulum nisl.",
...
ImageGridWithSlidheader.parameters = {
    docs: {
        description: {
            story: "ImageGrid component have clickable images in between SliderHeader and TextBlock.",
        },
        source: {
            code: `<ImageGrid {...${JSON.stringify(ImageGridWithSlidheader.args, null, 2)}}/>`,
        },
    },
};
// -------------------------------------------------------------
// ImageGridWithPresenter
// -------------------------------------------------------------
export const ImageGridWithPresenter = Template.bind({});
ImageGridWithPresenter.args = {
    data: {
        title: "Neque porro quisquam est qui dolorem",
        subtitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, curabitur ipsum sem",
        caption: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In suscipit euismod nisl vitae interdum. Mauris ac vestibulum nisl.",
...
ImageGridWithPresenter.parameters = {
    docs: {
        description: {
            story: "ImageGrid component have clickable images in between SliderHeader and TextBlock.",
        },
        source: {
            code: `<ImageGrid {...${JSON.stringify(ImageGridWithPresenter.args, null, 2)}}/>`,
        },
    },
};