...
export default {
  ...
  parameters: {
    componentSubtitle:
      "Displays a ImageGrid Slide having 4 clickable images as Grid  , TextBoxes, we can switch the slideHeader into header image by giving image prop and we can switch the slide into presenter view by giving presenter prop ",
    a11y: { disable: true },
    docs: {
      iframeHeight: 700,
    },
...
Default.parameters = {
  docs: {
    description: {
      story:
        "ImageGrid component have clickable images in between SliderHeader and TextBlock.",
    },
    source: {
