...
export default {
  ...
  parameters: {
    componentSubtitle:
      "Displays a ZoomableImage Slide TextBoxes, we can switch the slideHeader into header image by giving image prop and we can switch the slide into presenter view by adding presenter image to presenter prop ",
    a11y: { disable: true },
    docs: {
      iframeHeight: 700,
    },
...
Default.parameters = {
  docs: {
    description: {
      story:
        "ZoomableImage component have clickable images in between SliderHeader and TextBlock.",
    },
    source: {
      code: `<ZoomableImage {..${JSON.stringify(Default.args, null, 2)}}/>`,
    },
  },
};
// -------------------------------------------------------------
...
DefaultWithImage.parameters = {
  docs: {
    description: {
      story:
        "ZoomableImage component have image in between SliderHeader and TextBlock",
    },
    source: {
      code: `<ZoomableImage {...${JSON.stringify(
        DefaultWithImage.args,
        null,
        2
      )}}/>`,
...
// -------------------------------------------------------------
// ZoomableImageWithPresenter
// -------------------------------------------------------------
export const ZoomableImageWithPresenter = Template.bind({});
ZoomableImageWithPresenter.args = {
  data: {
    title: "Neque porro quisquam est qui dolorem",
    subtitle:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, curabitur ipsum sem",
