...
export default {
    ...
    parameters: {
        componentSubtitle: "Displays a ZoomableImage Slide TextBoxes, we can switch the slideHeader into header image by giving image prop and we can switch the slide into presenter view by adding presenter image to presenter prop ",
        a11y: { disable: true },
        docs: {
            iframeHeight: 700,
        },
