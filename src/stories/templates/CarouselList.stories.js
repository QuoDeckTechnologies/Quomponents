...
export default {
  ...
  parameters: {
    componentSubtitle:
      "Displays a carousel list with SlideHeader and a Html Carousel , slideHeader can be replaced by header image by giving image prop, component can be switched as presenter slide by giving presenter prop.",
    a11y: { disable: true },
    docs: {
      iframeHeight: 650,
    },
...
CarouselListWithPresenter.parameters = {
  docs: {
    source: {
      code: `<CarouselList {...${JSON.stringify(
        CarouselListWithPresenter.args,
        null,
        2
      )}}/>`,
