...
export default {
    ...
    parameters: {
        componentSubtitle: "Displays a carousel list with SlideHeader and a Html Carousel , slideHeader can be replaced by header image by giving image prop, component can be switched as presenter slide by giving presenter prop.",
        a11y: { disable: true },
        docs: {
            iframeHeight: 650,
        },
...
// -------------------------------------------------------------
// CarouselListWithPresenter
// -------------------------------------------------------------
export const CarouselListWithPresenter = Template.bind({});
CarouselListWithPresenter.args = {
    data: {
        title: "Neque porro quisquam est qui dolorem",
        subtitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, curabitur ipsum sem",
        backgroundImage: {
...
CarouselListWithPresenter.parameters = {
    docs: {
        source: {
            code: `<CarouselList {...${JSON.stringify(CarouselListWithPresenter.args, null, 2)}}/>`,
        },
    },
};

// -------------------------------------------------------------
// CarouselListWithImage
// -------------------------------------------------------------
export const CarouselListWithImage = Template.bind({});
CarouselListWithImage.args = {
    data: {
        title: "Neque porro quisquam est qui dolorem",
        subtitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, curabitur ipsum sem",
        image: {
...
CarouselListWithImage.parameters = {
    docs: {
        source: {
            code: `<CarouselList {...${JSON.stringify(CarouselListWithImage.args, null, 2)}}/>`,
        },
    },
};
