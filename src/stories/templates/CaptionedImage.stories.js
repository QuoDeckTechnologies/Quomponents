...
export default {
  ...
  parameters: {
    componentSubtitle:
      "Displays a CaptionedImage Slide having  clickable image and TextBoxes, we can switch the slideHeader into header image by giving image prop and we can switch the slide into presenter view by adding presenter image to presenter prop ",
    a11y: { disable: true },
    docs: {
      iframeHeight: 700,
    },
...
Default.args = {
  ...
  imageLibrary: [
    ...
    {
      image:
        "https://i.pinimg.com/564x/67/26/48/672648588c73a12f2101346d6ad98d7c.jpg",
      id: "image-1",
    },
  ],
  slideId: 0,
