...
ColoredIconBulletList.parameters = {
    docs: {
        description: {
            story:
                "Use to override the standard colors of the IconBulletList.",
        },
        source: {
            code: `<ColoredIconBulletList {...${JSON.stringify(
                ColoredIconBulletList.args,
                null,
                2
            )}}/>`,
...
// -------------------------------------------------------------
// Animated IconBulletList
// -------------------------------------------------------------
export const AnimatedIconBulletList = Template.bind({});
AnimatedIconBulletList.args = {
    ...Default.args,
    withAnimation: {
...
AnimatedIconBulletList.parameters = {
    docs: {
        description: {
            story:
                "Use to animate the entry of the IconBulletList with the standard animation options and set duration and delay. Can be used to make multiple components enter the screen in a queue.",
        },
        source: {
            code: `<AnimatedIconBulletList {...${JSON.stringify(
                AnimatedIconBulletList.args,
                null,
                2
            )}}/>`,
...
// -------------------------------------------------------------
// IconBulletList with slideHeader
// -------------------------------------------------------------
export const withSlideHeaderIconBulletList = Template.bind({});
withSlideHeaderIconBulletList.args = {
    ...Default.args,
    data: {
        title: "Neque porro quisquam est qui dolorem",
        subtitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, curabitur ipsum sem",
...
withSlideHeaderIconBulletList.parameters = {
    docs: {
        description: {
            story:
                "Use to show slideHeader in the IconBulletList.",
        },
        source: {
            code: `<withSlideHeaderIconBulletList {...${JSON.stringify(
                withSlideHeaderIconBulletList.args,
                null,
                2
            )}}/>`,
...
// -------------------------------------------------------------
// IconBulletList with image backgroundImage
// -------------------------------------------------------------
...
withBackgroundImageIconBulletList.parameters = {
    docs: {
        description: {
            story:
                "Use to show backgroundImage in the IconBulletList.",
        },
        source: {
            code: `<withBackgroundImageIconBulletList {...${JSON.stringify(
                withBackgroundImageIconBulletList.args,
                null,
                2
            )}}/>`,
