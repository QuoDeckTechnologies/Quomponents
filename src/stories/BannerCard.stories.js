...
const dictionary = JSON.stringify({
  hi: {
    bannerCard: {
      header: "बातचीत कक्ष",
      content:
        "प्रतियोगिता खेलें और फ्लिपकार्ट वाउचर अर्जित करने के लिए जीतें।",
    },
    ribbon: {
      new: "नया",
...
CardWithoutLabel.parameters = {
  docs: {
    description: {
      story:
        "We can pass image in url format, base64 format or pass an imported image.",
    },
    source: {
      code: `<BannerCard {...${JSON.stringify(
        CardWithoutLabel.args,
        null,
        2
      )}}/>`,
