...
PointColor.parameters = {
  docs: {
    ...
    source: {
      code: `<PointColor {...${JSON.stringify(PointColor.args, null, 2)}}/>`,
    },
  },
};
// -------------------------------------------------------------
...
LabelColor.parameters = {
  docs: {
    ...
    source: {
      code: `<LabelColor {...${JSON.stringify(LabelColor.args, null, 2)}}/>`,
    },
  },
};
// -------------------------------------------------------------
...
TranslatedReward.parameters = {
  docs: {
    ...
    source: {
      code: `<Reward {...${JSON.stringify(TranslatedReward.args, null, 2)}}/>`,
    },
  },
};
