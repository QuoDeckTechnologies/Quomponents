...
Default.parameters = {
  docs: {
    description: {
      story:
        "OverlayMenu Profile can contain the profile image of the user and it has userIcon by default if profile imgae is not avialable ,with the Caption",
    },
    source: {
...
PrimaryVariant.parameters = {
  docs: {
    description: {
      story: "Uses one of the five , Primary variant",
    },
    source: {
...
SecondaryVariant.parameters = {
  docs: {
    description: {
      story: "Uses one of the five , Secondary variant",
    },
    source: {
...
WarningVariant.parameters = {
  docs: {
    description: {
      story: "Uses one of the five , Warning variant",
    },
    source: {
...
SuccessVariant.parameters = {
  docs: {
    description: {
      story: "Uses one of the five , success variant",
    },
    source: {
...
ErrorVariant.parameters = {
  docs: {
    description: {
      story: "Uses one of the five , Error variant",
    },
    source: {
